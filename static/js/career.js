    ...
    return h('div', { class: 'cr' },
      ...
      h('div', { class: 'site-wrap cr-body' },
        ...
        section('education', 'Education', null, h('div', { class: 'cr-edu' }, data.education.map(e => h('article', { class: 'cr-card' },
          h('div', { class: 'cr-edu-head' }, e.logo ? h('img', { class: 'cr-edu-logo', src: e.logo, alt: e.school + ' logo', loading: 'lazy', width: 64, height: 64 }) : null,
            h('div', { class: 'cr-edu-main' }, h('h3', {}, e.degree), e.field_of_study ? h('p', { class: 'cr-strong' }, e.field_of_study) : null,
